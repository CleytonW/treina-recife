...
public class Exercicio06 {
        public static void main(String[] args) {
                ...
                System.out.println(
                                "Item adicionado a loja: " + item1.getNomeDoItem() + "\nCódigo do item adicionado é: "
                                                + item1.getIdentificador());

                Ferramenta ferramenta1 = new Ferramenta(456, "Martelo", "Ferramenta utilizadar para martelar", 10.99,
                                "Construção",
                                555);
